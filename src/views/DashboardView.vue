  ...
  <div class="page-shell space-y-6">
    <section class="relative overflow-hidden rounded-3xl bg-[#0b2f55] px-6 py-8 text-white shadow-2xl shadow-blue-950/15 sm:px-8 sm:py-10">
      ...
      <div class="relative max-w-3xl">
        ...
        <p class="mt-4 max-w-2xl text-sm leading-6 text-blue-100 sm:text-base">Genera referencias trazables a partir de oportunidades MANA, archivos propios o una combinación de ambas fuentes.</p>
