  ...
  <div class="page-shell space-y-6">
    <header class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div>
        ...
        <p class="page-description">Consulta las ejecuciones disponibles y las Ãºltimas lÃ­neas de su registro de actividad.</p>
      </div>
    ...
    <div v-else class="grid gap-6 xl:grid-cols-[23rem_1fr]">
      <section class="surface-card !p-0">
        ...
        <EmptyState v-else class="m-4" title="Sin ejecuciones" description="No se encontraron ejecuciones disponibles." />
      </section>
